...
LABELS_TMHMI = [
    ...
    Label(  'train'                 , 17 ,     16 ,      0.0    ,      (  0, 80,100) ), #
    Label(  'motorcycle'            , 18 ,     17 ,      0.0    ,      (  0,  0,230) ), #
    Label(  'bicycle'               , 19 ,     18 ,      0.0    ,      (119, 11, 32) ), #
    Label(  'forklift'              , 20 ,     19 ,      0.0    ,      (220,220,220) ), #
    Label(  'rack'                  , 21 ,     20 ,      0.0    ,      (248,248, 28) ), #
    Label(  'pallet'                , 22 ,     21 ,      0.0    ,      (189, 16,224) ), #
    Label(  'object'                , 23 ,     22 ,      0.0    ,      (114, 74,  0) ), #
    Label(  'mast'                  , 24 ,    255 ,      0.0    ,      ( 65,117,  5) ), #
    Label(  'container'             , 25 ,    255 ,      0.0    ,      ( 81,  0, 81) ), #
    Label(  'crane'                 , 26 ,    255 ,      0.0    ,      ( 80,227,194) )  #
]   
